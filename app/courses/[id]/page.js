...
//                 const newRes = await fetch(`http://localhost:8000/api/courses/${id}/`, {
//                   headers: {
//                     "Content-Type": "application/json",
//                     Authorization: `Bearer ${token}`,
//                   },
...
//                   throw new Error(`Failed to fetch course: ${newRes.status} - ${errorText}`);
//                 }
...
//         style={{
//           backgroundImage: `url(https://img.youtube.com/vi/${course.intro_video_id}/maxresdefault.jpg)`,
//         }}
//       >
...
//         {/* Enroll Button */}
//         <Button className="mt-6 w-full text-lg py-6">Enroll Now</Button>
//       </div>
//     </div>
//   );
// }
...
import { useAuth } from "@/app/context/AuthContext"; // Assuming you have this context
