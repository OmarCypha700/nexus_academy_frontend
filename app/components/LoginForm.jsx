...
//           <p className="text-smflex text-center pt-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                {/* H4: was href="#" — a dead link, since no request-reset page existed
                    anywhere in the app until ForgotPasswordForm.jsx was added. */}
